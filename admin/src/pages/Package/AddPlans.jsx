          ...
          <>
            <table className="users-table">
              <thead>
                <tr>
                  ...
                  <th onClick={() => requestSort('role')}>
                    Monthly Plans{getSortIndicator('role')}
                  </th>
                  <th onClick={() => requestSort('status')}>
                    Free Package{getSortIndicator('status')}
                  </th>
                  <th>Actions</th>
                </tr>
              </thead>
              ...
              >
                ...
                <option value="Pop">1 Month - 1999 </option>
                <option value="Rock">2 Month - 2999</option>
                <option value="Hip Hop">3 Month - 4999</option>
                <option value="Electronic">6 Month- 7999</option>
                <option value="Classical">1 Year - 17999</option>
              </select>
            </div>
                    </td>
                    <td>
              ...
              <select
                ...
                // onChange={handleChange}
              >
                <option value="">Select free packages</option>
                <option value="Pop">1 Month - swimming</option>
                <option value="Rock">1 Month - massage</option>
